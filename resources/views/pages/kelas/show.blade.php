            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        ...
                        <div class="ml-auto">
                            <a type="submit" href="{{ url('kelas/' . $item->id . '/add') }}"
                                class="btn btn-primary"v>Tambah</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <tbody>
                                    @forelse ($mahasiswa as $index => $items)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="/deleteMahasiswa/{{ $items->id }}" method="post"
                                                    class="d-inline">
                                                    <input type="hidden" value="{{ $items->id }}" name="id">
                                                    <input type="hidden" value="{{ $idKelas }}" name="idKelas">
                                                    <input type="hidden" value="{{ $jumlahMahasiswa }}"
