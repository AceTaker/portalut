...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <a href="<?php echo e(route('prodi.index')); ?>" class="btn btn-success pull-left">
...
unset($__errorArgs, $__bag); ?>" id="exampleFormControlSelect1" name="id_fakultas">
                              ...
                              <?php $__currentLoopData = $fakultas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>"><?php echo e($item->fakultas); ?></option>
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kode_prodi" value="<?php echo e(old('kode_prodi')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="prodi" value="<?php echo e(old('prodi')); ?>" 
                            class="form-control <?php $__errorArgs = ['prodi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control <?php $__errorArgs = ['jenjang'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="exampleFormControlSelect1" name="jenjang">
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control <?php $__errorArgs = ['ka_prodi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="exampleFormControlSelect1" name="ka_prodi">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\portalut\resources\views/pages/prodi/create.blade.php ENDPATH**/ ?>