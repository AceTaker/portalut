          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="<?php echo e(route('mahasiswa.update', $item->id)); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nim" value="<?php echo e(old('nim') ? old('nim') : $item->nim); ?>" 
...
unset($__errorArgs, $__bag); ?>" id="exampleFormControlSelect1" name="id_prodi">
                            <?php $__currentLoopData = $prodi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemP): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($item->id_prodi == $itemP->id): ?>
                                <option value="<?php echo e($itemP->id); ?>" selected><?php echo e($itemP->prodi); ?></option>
                              <?php else: ?>
                                <option value="<?php echo e($itemP->id); ?>"><?php echo e($itemP->prodi); ?></option>
                              <?php endif; ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <img src="/image/mahasiswa/<?php echo e($item->photo); ?>" width="100" height="100" alt="No image" class="img-thumbnail gambar">
                        </div>
                      </div>
                    </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\portalut\resources\views/pages/mahasiswa/edit.blade.php ENDPATH**/ ?>